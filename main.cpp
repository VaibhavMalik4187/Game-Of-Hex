//===============================================================================================//
// Header:                                                                                       //
//  Homework 5 - C++ for C Programmers - Coursera 2013                                           //
//                                                                                               //
//  Created by Salehe Erfanian Ebadi - s.erfanianebadi@qmul.ac.uk                                //
// Purpose:                                                                                      //
//  This C++ program is the Hex Game Board - Computer vs. Human - Monte Carlo Hex Move           //
//                                                                                               //
// IDE used to develop the program:                                                              //
//  Microsoft Visual Studio Express 2013 for Windows Desktop Version 12.0.21005.1 REL            //
//                                                                                               //
// To run:                                                                                       //
//  Simply run the program and play with the appropriate input following the instructions.       //
//===============================================================================================//
...
// board size can be changed (tweak the code)
...
bool HEX_Game::IsValid(Coord const& posn) const
{
...
//
bool HEX_Game::GoodSwap(Coord const& move) const
{
